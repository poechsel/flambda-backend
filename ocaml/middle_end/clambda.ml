...
and ulambda =
  ...
  | Ustringswitch of ulambda * (string * ulambda) list * ulambda option * Lambda.value_kind
  ...
  | Ucatch of
      ...
      ulambda *
      ulambda
  | Utrywith of ulambda * Backend_var.With_provenance.t * ulambda * Lambda.value_kind
